<div class="container px-5 my-5">
    <div class="text-center mb-5">
        <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">List Putusan</span></h1>
    </div>
                        ...
                        <div class="row align-items-center gx-5">
                            <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                <div class="bg-light p-6 rounded-4">
                                    ...
                                    <div class="small fw-bolder">121/Pdt.G/2023/PA.Bitg</div>
                                    <div class="small text-muted">Gugatan</div>
                                    <div class="small text-muted">Hak Asuh Anak</div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus laudantium, voluptatem quis repellendus eaque sit animi illo ipsam amet officiis corporis sed aliquam non voluptate corrupti excepturi maxime porro fuga.</div>
                                <button class="btn btn-info">Download Putusan</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center gx-5">
                            <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                <div class="bg-light p-6 rounded-4">
                                    ...
                                    <div class="small fw-bolder">101/Pdt.G/2023/PA.Mdo</div>
                                    <div class="small text-muted">Gugatan</div>
                                    <div class="small text-muted">Hak Asuh Anak</div>
                                </div>
                            </div>
